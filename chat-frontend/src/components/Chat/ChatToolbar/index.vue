<template>
    ...
    <chat-popup :options="opt5" :bottom="55" :left="10" :width="500" :height="400" title="推荐用户">
			<toolbar-recommend />
		</chat-popup>
      ...
      <div :class="[ 'toolbar-left-item', ' flex_center', { 'active-menu': opt4.show }]" @click.stop="openBox(5)">
				<!-- <icon name="el-icon-attract" class="m_r5" scale="1.6" /> -->
        <i class="el-icon-attract m_r5" scale="1.6"></i>
				推荐
			</div>
...
import ToolbarRecommend from "./components/ToolbarRecommend.vue";
